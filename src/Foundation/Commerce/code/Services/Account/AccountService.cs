...
namespace Wooli.Foundation.Commerce.Services.Account
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public Result<IEnumerable<Address>> AddAddresses(string userName, Address address)
        {
        ...
        public Result<IEnumerable<Address>> RemoveAddress(string userName, Address address)
        {
            ...
            return this.ExecuteWithParties<IEnumerable<Address>>(
                ...
                (commerceCustomer, parties, result) =>
                {
                    ...
                    {
                        return this.GetAddress(userName);
                    }
        ...
        public Result<VoidResult> ValidateEmail(string email)
        {
            ...
            var getUserResult = this.accountManager.GetUsers(email: email);
        ...
        public Result<T> ExecuteWithParties<T>(
            string userName,
        ...
        public Result<CommerceCustomer> GetCustomerByName(string userName)
        {
            Assert.ArgumentNotNullOrEmpty(userName, nameof(userName));
